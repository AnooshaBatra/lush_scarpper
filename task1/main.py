...
write_to_csv(os.path.dirname(os.path.abspath(__file__))+"\\all_hair.csv", data_frame=data_frame)
...
write_to_csv(os.path.dirname(os.path.abspath(__file__))+"\\conditioner.csv", data_frame=df)